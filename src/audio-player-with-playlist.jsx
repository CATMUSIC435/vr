...
export default function AudioPlayerWithPlaylist() {
    ...
    return (
        <div className={clsx(!isExpanded ? 'w-[80px] md:w-[90px] fixed top-2 md:top-auto md:bottom-4 right-2 shadow-xl rounded-xl shadown-inner bg-white/10 backdrop-blur-md z-50' : 'fixed top-2 md:top-auto md:bottom-4 right-2 w-[260px] md:w-[300px] shadow-xl rounded-xl shadown-inner bg-white/10 backdrop-blur-md z-50')}>
